package com.ssl_service;

import com.ssl_models.SSLCommerzInitResponse;
import com.ssl_models.SSLCommerzValidatorResponse;
import com.ssl_utils.ParameterBuilder;
import com.ssl_utils.Util;
...
public class SSLCommerz {
    ...
    private String storeId="brain60a7c6b15f97e";
    private String storePass="brain60a7c6b15f97e@ssl";
...
//    private String sslczURL = "https://securepay.sslcommerz.com/";
    ...
    private void setSSLCzTestMode(boolean storeTestMode) {
        ...
        if (storeTestMode) {
            this.storeId = "brain60a7c6b15f97e";
            this.storePass = "brain60a7c6b15f97e@ssl";
